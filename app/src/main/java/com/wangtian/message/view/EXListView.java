...
public class EXListView extends SwipeMenuListView implements OnScrollListener {

	private float mLastY = -1; // save event y
	public Scroller mScroller; // used for scroll back
